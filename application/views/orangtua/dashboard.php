<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 50px;">
        <div class="container text-center my-5 py-5">
            <h1 class="text-white  mb-4">E-raport</h1>
            <img src="<?php echo base_url()?>assets/img/logo.jpg" alt="">
            <h1 class="text-white  mb-5">SMA AL-BASHRY KALAPANUNGGAL</h1>
            <button type="button" class="btn btn-success px-10 px-lg-5" href="<?= site_url('orangtua/rekapnilai');?>">Rekap Nilai -></button>
