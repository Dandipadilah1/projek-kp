    ...
    <?php foreach ($profil as $pf) : ?>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h1 class="h3 mb-2 text-gray-800">Selamat Datang di Aplikasi  website Pengolahan Data Nilai (Raport)<h1><img src="<?php echo base_url().'/uploads/.$pf->gambar'?>" alt="" width="200" height="200"> 
            </div>
            <div class="card-body">
